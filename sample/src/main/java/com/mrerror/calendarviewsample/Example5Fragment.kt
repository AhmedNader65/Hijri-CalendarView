...
import com.mrerror.calendarviewsample.databinding.Example5CalendarDayBinding
import com.mrerror.calendarviewsample.databinding.Example5CalendarHeaderBinding
import com.mrerror.calendarviewsample.databinding.Example5EventItemViewBinding
import com.mrerror.calendarviewsample.databinding.Example5FragmentBinding
...
class Example5Fragment : BaseFragment(R.layout.example_5_fragment), HasToolbar {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.exFiveCalendar.setup(5, 5, daysOfWeek.first(), TYPE.HIJRI)
...
//                    layout.setBackgroundResource(if (selectedDate == day.date) R.drawable.example_5_selected_bg else 0)
                    val localDate =
                        LocalDateTime.ofInstant(day.date.yearMonth.toInstant(), day.date.yearMonth.timeZone.toZoneId())
                            .toLocalDate()
        ...
        binding.exFiveCalendar.monthScrollListener = { month ->
            val ar = Locale("ar")
            val title = "${month.calendar.getDisplayName(Calendar.MONTH, Calendar.LONG, ar)} - ${month.calendar.get(Calendar.YEAR)}"
